# Qol Tweaks
## Installation
Download and unzip the zip file from the mod's [Releases](https://github.com/AlurienFlame/qol-tweaks/releases), and place the resulting folder in the `mods` folder of your Allumeria install. This mod depends on the [ignitron](https://github.com/danilwhale/ignitron) mod loader, and you should have created a `mods` folder while installing that.
## Features
